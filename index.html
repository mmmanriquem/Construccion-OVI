        ...
        <header>
            <div class="container text-center">
                <div class="row">
                    ...
                    <div class="col-md-11">
                        <h1 class="title-site">Introducción al Desarrollo de Software <i class="fa fa-code"></i></h1>
                    </div>
                </div>
            </div>
        </header>
        <nav class="navbar navbar-static-top navbar-default">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php">Introducción al Desarrollo de Software <i class="fa fa-code"></i></a>
                </div>
                ...
                <div class="col-md-9">
                    <div class="contenido">
                            <article>
                                ...
                                <a title="Unidad 1" href="unidad1.php"><img src="img/Esquema_general.png" alt="" /></a>
                                <div>
                                    <h3>Objetivo</h3>
                                    <br>
                            ...
                            <article>
                                ...
                                <a title="Unidad 2" href="unidad2.php"><img src="img/Modelo.jpg" alt="" /></a>
                                <div>
                                    <h3>Objetivo</h3>
                                    <br>
