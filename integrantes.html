    ...
    <div id="wrapper">
        <header>
            <div class="container text-center">
                <div class="row">
                    ...
                    <div class="col-md-11">
                        <h1 class="title-site">Integrantes <i class="fa fa-code"></i></h1>
                    </div>
                </div>
            </div>
        </header>
        <nav class="navbar navbar-static-top navbar-default">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php">Integrantes <i class="fa fa-code"></i></a>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-9">
                    <div class="contenido">
                        <h2>MARLON M MANRIQUE</h2>
                        <h2>WILSON ANDREY PINZON</h2>
                        <h2>DAIRA MARGELY BERMEO</h2>
                        <h2>CARLOS ALBERTO ACERO CONTRERAS</h2>
                    </div>
                </div>
                <div class="col-md-3">
